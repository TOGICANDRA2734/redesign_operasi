...
class ProduksiInvoiceJointSurveyController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        SUM(IF(kode=\"bud\",ob,0)) ob_bud,
        SUM(IF(kode=\"bud\",coal,0)) coal_bud,
        SUM(IF(kode=\"js\",ob,0)) ob_js,
        SUM(IF(kode=\"js\",coal,0)) coal_js,
        SUM(IF(kode=\"inv\",ob,0)) ob_inv,
        SUM(IF(kode=\"inv\",coal,0)) coal_inv,
        (SUM(IF(kode=\"inv\",ob,0))/SUM(IF(kode=\"bud\",ob,0))*100) ach_ob,
        (SUM(IF(kode=\"inv\",coal,0))/SUM(IF(kode=\"bud\",coal,0))*100) ach_coal
        FROM summ
