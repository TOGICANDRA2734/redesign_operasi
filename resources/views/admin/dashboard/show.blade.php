...
<div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="dropdown ml-auto md:mt-0">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content overflow-y-auto h-32">
                                    @foreach($pit as $pt)
                                    <li><a href="{{route('admin.dashboard.show.filtered', ['site' => $site, 'pit' => $pt->ket])}}" class="dropdown-item">{{$pt->ket}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
    ...
    <div class="bg-white col-span-12 p-5">
        <div class="intro-y mt-5 pt-5">
            ...
            <form method="post" action="{{ route('admin.comments.store') }}" class="news__input relative mt-5 grid grid-cols-12 gap-5">
                @csrf
