    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            {{-- <div class="w-full sm:w-auto relative ml-auto mt-3 sm:mt-0">
                ...
                <div class="text-center">
                    <div class="dropdown inline-block" data-tw-placement="bottom-start"> 
                        ...
                        class="inbox-filter__dropdown-menu dropdown-menu pt-2">
                        @csrf
                            ...
                            <div class="grid grid-cols-12 gap-4 gap-y-3 p-3">
                                <div class="col-span-6">
                                    ...
                                    <input id="input-filter-1" type="text" class="form-control flex-1"
                                        placeholder="Cth AD45/AD45001" name="cari_2">
                                </div>
                                <div class="col-span-6">
                                    <label for="input-filter-3" class="form-label text-xs">Site</label>
                                    <select id="input-filter-4" class="form-select flex-1" name="pilihSite">
                                        <option value="" selected disabled>Pilih</option>
                                        @foreach ($site as $st)
                                            <option value="{{ $st->kodesite }}">{{ $st->namasite }} - {{ $st->lokasi }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-span-12 flex justify-center items-center mt-3">
                                    <button data-dismiss="dropdown" type="button" class="btn btn-secondary flex-1 mr-2">Close</button>
                                    <button type="submit" class="btn btn-primary flex-1 ml-2">Search</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('mohh-harian.index')}}" id="urlFilter">
            ...
            console.log(response)
                ...
                $j.each(response.data, function(index, data) {
                    ...
                    $j.each(data, function(i, d){ 
                        if(i != 'nom_unit' && i != 'jum' && i != 'x_total' && (d != 24)){
                            text += "<td class=\"whitespace-nowrap text-center text-red-600\"> " + d + "</td>"
                        }
                        else {
