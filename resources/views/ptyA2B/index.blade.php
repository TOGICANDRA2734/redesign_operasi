    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('pty-a2b.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th colspan="4" class="whitespace-nowrap text-center">JAM UNIT</th>
                            <th colspan="3" class="whitespace-nowrap text-center">PRODUKSI</th>
                            <th colspan="3" class="whitespace-nowrap text-center">PEMAKAIAN SOLAR</th>
                        ...
                        <tr>
                            ...
                            <th class="whitespace-nowrap text-center">STB</th>
                            <th class="whitespace-nowrap text-center">BD</th>
                            <th class="whitespace-nowrap text-center">MOHH</th>
                            ...
                            <th class="whitespace-nowrap text-center">LITER</th>
                            <th class="whitespace-nowrap text-center">LTR/HRS</th>
                            <th class="whitespace-nowrap text-center">LTR/BCM</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($data as $key => $dt)
                            <tr class="text-center {{$dt->nom_unit == 'SUB TOTAL' ? "bg-gray-300 text-red-700 font-bold" : "bg-white"}}  ">
                                ...
                                @foreach ($dt as $k => $d)
                                    @if ($k !== 'mohh' || $k !== 'pty' || $k !== 'ob' || $k !== 'jarak' || $k !== 'liter')
                                        <td class="whitespace-nowrap text-center">
                                            {{ number_format($d,1) }}
                                        </td>
                                    @else
