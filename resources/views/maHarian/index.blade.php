    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('ma-harian.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th rowspan="2" class="whitespace-nowrap text-center">MA TOTAL (%)</th>
                            <th colspan="31" class="whitespace-nowrap text-center">MECHANICAL AVAILABILITY (MA)</th>
                        </tr>
                        <tr>
                            @for ($i = 0;  $i<31; $i++)
