    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('hours-distribution-tp.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th colspan="7" class="whitespace-nowrap text-center">Jam Kerja</th>
                        ...
                        <tr>
                            ...
                            <th class="whitespace-nowrap text-center">ROM</th>
                            <th class="whitespace-nowrap text-center">PORT</th>
