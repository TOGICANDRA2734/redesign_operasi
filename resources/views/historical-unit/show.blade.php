...
<script>
    ...
    $i('#pilihSite').on('change', function() {
        ...
        console.log("PILIH Site", kodesite, cariNama, nom_unit);

        $i.ajax({
            type: "POST",
            url: 'http://ptrci.co.id/datacenter/public/historical-unit-show-filter?layout=side-menu',
            data: {
                'kodesite': kodesite,
                'cariNama': cariNama,
                'nom_unit': nom_unit,
                ...
                if (result) {
                    ...
                    $i.each(result.data, function(index) {
                        ...
                        text = '<tr class="text-center bg-white">' +
                            ...
                            '<td class="">' + result.data[index].status_sr + '</td>' +
                            '<td class="">' + result.data[index].hm_fix + '</td>' +
    ...
    $i('#cariNama').on('change', function() {
        ...
        console.log("PILIH Nama", kodesite, cariNama, nom_unit);
