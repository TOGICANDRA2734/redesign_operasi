        ...
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="flex justify-between items-center col-span-12 mt-5">
                ...
                <div class="ml-auto flex justify-center items-center">
                    ...
                    {{-- Url Rujukan --}}
                    <input type="hidden" name="url" value="{{route('kendala.index')}}" id="urlFilter">
                ...
                if (response) {
                    $j.each(response.data, function(index, element) {
                        ...
                        text = '<tr class="text-center bg-white">' +
                            '<td class="">' + number + '</td>' +
                            '<td class="">' + response.data[index].tgl + '</td>' +
                            '<td class="">' + response.data[index].unit + '</td>' +
                            '<td class="">' + response.data[index].shift + '</td>' +
                            '<td class="">' + response.data[index].awal + '</td>' +
                            '<td class="">' + response.data[index].akhir + '</td>' +
