    ...
    @section('subcontent')
        ...
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="flex justify-between items-center col-span-12 mt-5">
                ...
                <div class="ml-auto flex justify-center items-center">
                    ...
                    {{-- Url Rujukan --}}
                    <input type="hidden" name="url" value="{{route('productivity.index')}}" id="urlFilter">
                    ...
                    <table class="w-full table table-sm">
                        <thead class="table-dark sticky left-0 top-0 z-50">
                            <tr class="">
                                ...
                                <th rowspan="2" class="whitespace-nowrap text-center" style="width: 7rem">Tanggal</th>
                            ...
                            <tr class="text-xs font-semibold tracking-wide text-center text-white uppercase border-b dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800">
                                @for($i=0; $i<=23; $i++) <th class="whitespace-nowrap text-center">{{$i}}</th>
                                    @endfor
                            </tr>
                        </thead>
        ...
        <script>
            ...
            function update_data(response){
                ...
                if (response) {
                    $j.each(response.data, function(index, element) {
                        var number = index + 1

                        text = '<tr class="text-center bg-white">' +
                            '<td class="">' + number + '</td>' +
                            '<td class="">' + response.data[index].tanggal + '</td>' +
                            '<td class="">' + response.data[index].nom_unit + '</td>' +
                            '<td class="">' + response.data[index].namasite + '</td>' +
                            '<td class="">' + response.data[index].pit + '</td>' +
                            '<td class="">' + response.data[index].avg_pty + '</td>' +
                            '<td class="">' + response.data[index].j1 + '</td>' +
                            '<td class="">' + response.data[index].j2 + '</td>' +
                            '<td class="">' + response.data[index].j3 + '</td>' +
                            '<td class="">' + response.data[index].j4 + '</td>' +
                            '<td class="">' + response.data[index].j5 + '</td>' +
                            '<td class="">' + response.data[index].j6 + '</td>' +
                            '<td class="">' + response.data[index].j7 + '</td>' +
                            '<td class="">' + response.data[index].j8 + '</td>' +
                            '<td class="">' + response.data[index].j9 + '</td>' +
                            '<td class="">' + response.data[index].j10 + '</td>' +
                            '<td class="">' + response.data[index].j11 + '</td>' +
                            '<td class="">' + response.data[index].j12 + '</td>' +
                            '<td class="">' + response.data[index].j13 + '</td>' +
                            '<td class="">' + response.data[index].j14 + '</td>' +
                            '<td class="">' + response.data[index].j15 + '</td>' +
                            '<td class="">' + response.data[index].j16 + '</td>' +
                            '<td class="">' + response.data[index].j17 + '</td>' +
                            '<td class="">' + response.data[index].j18 + '</td>' +
                            '<td class="">' + response.data[index].j19 + '</td>' +
                            '<td class="">' + response.data[index].j20 + '</td>' +
                            '<td class="">' + response.data[index].j21 + '</td>' +
                            '<td class="">' + response.data[index].j22 + '</td>' +
                            '<td class="">' + response.data[index].j23 + '</td>' +
                            '<td class="">' + response.data[index].j24 + '</td>' +
                            '<td class="">' + response.data[index].dist + '</td>' +
                            '<td class="">' + response.data[index].ket + '</td>' +
                            '</tr>';
                        fullText += text
                    });
