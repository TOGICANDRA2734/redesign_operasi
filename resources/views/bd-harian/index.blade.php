            ...
            <table class="w-full table table-striped ">
                ...
                <tbody>
                    <tr class="text-center bg-white">
                        ...
                        <td class="whitespace-nowrap text-center">KE12020</td>
                        <td class="whitespace-nowrap text-center">1000</td>
                        <td class="whitespace-nowrap text-center">Breakdown</td>
                        <td class="whitespace-nowrap text-center">B1</td>
                        <td class="whitespace-nowrap text-center">12/12/2022</td>
                        <td class="whitespace-nowrap text-center">12/12/2022</td>
                        <td class="whitespace-nowrap text-center">50</td>
                        <td class="whitespace-nowrap text-center">KE</td>
                        <td class="whitespace-nowrap text-center">
                            <a href="{{route('super_admin.bd-harian-detail.index', 1)}}" class="btn btn-dark mr-1 mb-2"> <i data-lucide="eye" class="w-5 h-5"></i></a>
                        </td>
                    </tr>
