...
<main class="h-full overflow-y-auto">
    <div class="container mx-auto grid grid-cols-12 gap-5">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200 col-span-12">
            Populasi Unit - {{$data[0]->model}}            
        </h2>

        <!-- Data RFU -->
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-5 mb-5 col-span-12 sm:col-span-6">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach($dataBD as $key => $dt)
                            <tr class="group data-row text-center text-gray-700 dark:text-gray-400 hover:bg-gray-400 hover:text-white ease-in-out duration-150" onclick="changeColor(this)">
                                ...
                                @endforeach
                                <td>
                                    <a href="{{route('bd-harian-detail.index', $dt->nom_unit)}}">cek</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
