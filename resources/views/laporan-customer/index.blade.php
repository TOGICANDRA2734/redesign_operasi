...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <h2 class="text-lg font-medium truncate mr-5 ">
                Laporan Bulanan terhadap Target Customer
            </h2>
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('laporan-customer.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th colspan="2" class="whitespace-nowrap text-center uppercase">Budget</th>
                            <th colspan="4" class="whitespace-nowrap text-center uppercase">Joint Survey</th>
                            <th colspan="4" class="whitespace-nowrap text-center uppercase">Invoice</th>
                        </tr>
                        <tr>
                            ...
                            <th class="whitespace-nowrap text-center">OB</th>
                            <th class="whitespace-nowrap text-center">Coal</th>
                            <th class="whitespace-nowrap text-center">ACH OB (%)</th>
                            <th class="whitespace-nowrap text-center">ACH Coal (%)</th>
                            <th class="whitespace-nowrap text-center">OB</th>
                            <th class="whitespace-nowrap text-center">Coal</th>
                            <th class="whitespace-nowrap text-center">ACH OB (%)</th>
                            <th class="whitespace-nowrap text-center">ACH Coal (%)</th>
    ...
    <script>
        ...
        function show_data() {
            Toastify({
                node: $j("#success-notification-content")
                    .clone()
