    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <h2 class="text-lg font-medium truncate mr-5 ">
                Produksi Customer Joint Survey
            </h2>
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('customer-joint-survey.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th colspan="2" class="whitespace-nowrap text-center">CUSTOMER</th>
                    ...
                    <tbody>
                        @foreach ($data as $key => $dt)
                            <tr class="text-center {{$dt->bulan == 'SUB TOTAL' ? "bg-gray-300 text-red-700 font-bold" : "bg-white"}}  ">
                                {{-- <td class="whitespace-nowrap text-center">
                                    {{ $key + 1 }}
                                </td> --}}
                                @foreach ($dt as $k => $d)
                                    @if ($k == 'ach_ob' || $k == 'ach_coal' )
                                        <td class="whitespace-nowrap text-center">
                                            {{ number_format($d,1) }}
                                        </td>
                                    @else
                                    <td class="whitespace-nowrap text-center">
                                        @if ($k == 'ob_bud' || $k == 'coal_bud' || $k == 'ob_js' || $k == 'coal_js' || $k == 'ob_cust' || $k == 'coal_cust' )
                                            {{ number_format($d,0) }}                                        
                                        @else
            ...
            console.log(response)
                        ...
                        $j.each(response.data, function(index, data) {
                            ...
                            $j.each(data, function(i, d){
                                ...
                                } else if (i == 'ob_bud' || i == 'coal_bud' || i == 'ob_js' || i == 'coal_js' || i == 'ob_cust' || i == 'coal_cust') {
