...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-5">
        ...
        <div class="flex justify-between items-center col-span-12 mt-5">
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                {{-- Url Rujukan --}}
                <input type="hidden" name="url" value="{{route('hours-distribution-a2b.index')}}" id="urlFilter">
                ...
                <table class="w-full table table-sm">
                    <thead class="table-dark sticky left-0 top-0 z-50">
                        <tr class="">
                            ...
                            <th colspan="18" class="whitespace-nowrap text-center">Jam Kerja</th>
                            <th rowspan="2" class="whitespace-nowrap text-center">MOHH</th>
                            <th rowspan="2" class="whitespace-nowrap text-center">BD</th>
                            <th rowspan="2" class="whitespace-nowrap text-center">STB</th>
                            <th rowspan="2" class="whitespace-nowrap text-center">MA (%)</th>
                            <th rowspan="2" class="whitespace-nowrap text-center">UT (%)</th>
                            <th colspan="18" class="whitespace-nowrap text-center">STANDBY FIGURE</th>
                        </tr>
                        <tr>
                            <th class="whitespace-nowrap text-center">LAND CLEARING</th>
                            <th class="whitespace-nowrap text-center">RIPPING</th>
                            <th class="whitespace-nowrap text-center">DOZING</th>
                            <th class="whitespace-nowrap text-center">RIPPING DOZING</th>
                            <th class="whitespace-nowrap text-center">SPREADING</th>
                            <th class="whitespace-nowrap text-center">LOADING RIPPING</th>
                            <th class="whitespace-nowrap text-center">LOADING LANGSUNG</th>
                            <th class="whitespace-nowrap text-center">LOADING STOCK</th>
                            <th class="whitespace-nowrap text-center">LOADING BLASTING</th>
                            <th class="whitespace-nowrap text-center">LOADING MUD</th>
                            <th class="whitespace-nowrap text-center">LOADING COAL</th>
                            <th class="whitespace-nowrap text-center">MAINT ROAD OB</th>
                            <th class="whitespace-nowrap text-center">DRILLING</th>
                            <th class="whitespace-nowrap text-center">MAINT ROAD COAL</th>
                            <th class="whitespace-nowrap text-center">TRAV</th>
                            <th class="whitespace-nowrap text-center">GEN</th>
                            <th class="whitespace-nowrap text-center">RENT</th>
                            <th class="whitespace-nowrap text-center">TOTAL</th>
                            @for ($i = 0; $i<=17; $i++)
                                <th class="whitespace-nowrap text-center">{{$i < 10 ? "S0".$i : "S".$i}}</th> 
                            @endfor
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($data as $key => $dt)
                            <tr class="text-center {{$dt->nom_unit == 'SUB TOTAL' ? "bg-gray-300 text-red-700 font-bold" : "bg-white"}}  ">
    ...
    <script>
        ...
        // Pilih Site
        $j("#kodesite, #cariNama").on('change', function() {
            $j.ajaxSetup({
                headers: {
        ...
        function update_data(response){
            console.log(response)
                        ...
                        $j.each(response.data, function(index, data) {
                            ...
                            nom_unit = (data['nom_unit'] == 'SUB TOTAL') ? "bg-gray-300 text-red-700 font-bold" : "bg-white";
                            text = "<tr class=\"text-center  " + nom_unit + "\">"

                            

                            if(isLastElement){
                                data['nom_unit'] = "GRAND TOTAL"
                            }
